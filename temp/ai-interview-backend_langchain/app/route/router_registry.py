...
CLIENT_ROUTES = [
    ...
    RouteConfig(
        module_path="app.api.client.v1.position_template",
        prefix=f"{settings.API_V1_STR}/position-templates",
        tags=["client-position-templates"]
    ),
]
...
BACKOFFICE_ROUTES = [
    ...
    RouteConfig(
        module_path="app.api.backoffice.v1.llm_config",
        prefix=f"{settings.API_V1_STR}/backoffice/llm-configs",
        tags=["backoffice-llm-config"]
    ),
    RouteConfig(
    ...
    RouteConfig(
        module_path="app.api.backoffice.v1.position_templates",
        prefix=f"{settings.API_V1_STR}/backoffice/position-templates",
        tags=["backoffice-position-templates"]
    ),
    RouteConfig(
        module_path="app.api.backoffice.v1.llm_logs",
        prefix=f"{settings.API_V1_STR}/backoffice/llm-logs",
        tags=["backoffice-llm-logs"]
    ),
]
