  ...
  <div class="admin-layout">
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <router-link to="/admin/llm-config" active-class="active">
        ...
        <router-link to="/admin/documents" active-class="active">
          <span class="nav-icon">&#x1F4C4;</span> 文档管理
        </router-link>
        <router-link to="/admin/position-templates" active-class="active">
